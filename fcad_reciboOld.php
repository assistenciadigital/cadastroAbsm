...
if(document.cadastro.fvalor.value=="")
	...
	if(document.cadastro.fftitular.value=="")
	{
	alert("O Campo titular é obrigatório!");
	return false;
	}
else
return true;
...
<form action="ccad_recibo.php" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onsubmit="return validacampos(); return false;">
<table width="680" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left"><strong>Valor R$:</strong></td>
    <td width="650" align="left"><input name="fvalor" type="text" id="fvalor" size="20" maxlength="20" style="width:130px" />
      <strong>(formato: 0.00)</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left">
      <select name="femitente" id="femitente" style="width:130px">
        <option value=""></option>
        <?php 
  ...
  <tr>
    ...
    Mês/Ano:
    <label for="fmes_ano2"></label>
    <input name="fmes_ano" type="text" id="fmes_ano2" size="4" maxlength="7" />
    <strong>
    <label for="fdescricao"></label>
 contribuição associativa.</strong></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><strong>
      <input name="fdescricao" type="text" id="fdescricao" size="60" maxlength="100" />
...
$sqlrecibo = "SELECT recibo,valor,emitente,destinatario,tipo,referencia,descricao,data,hora,usuario FROM recibo";
$rsrecibo = mysql_query($sqlrecibo);


while(list($recibo,$valor,$emitente,$destinatario,$tipo,$referencia,$descricao,$data,$hora,$usuario) = mysql_fetch_row($rsrecibo)) {
$pega_emitente = $emitente;
$pega_destinatario = $destinatario;
$pega_tipo = $tipo;
$numero = $valor;
$pega_valor = number_format($valor, 2, ',', '.');
...
<table width="640" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    <td width="100" height="35" align="center" valign="middle" scope="col"><strong><?php print $recibo; ?></strong></td>
    ...
    <td width="23" align="left" scope="col"><a href="falt_recibo.php?recibo=<?php print $recibo; ?>"><img src="imagem/ico-refresh.png" alt="" width="23" height="23"/></a><br/>
      <a href="frel_recibo.php?recibo=<?php print $recibo; ?>" target="_blank"><img src="imagem/ico-printer.png" alt="" width="23" height="23"/></a></td>
    </tr>
</table>
<?php }?>
</div>
...
<table width="640" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="277" align="left" scope="col"><strong>Registro(s) Encontrado(s): </strong><?php print $contador; ?></td>
    <td width="363" align="right" scope="col"> Alterar = <img src="imagem/ico-refresh.png" alt="" width="23" height="23"/> Exclusão = <img src="imagem/ico-delete.png" alt="" width="23" height="23"/> Impressão = <img src="imagem/ico-printer.png" alt="" width="23" height="23"/></td>
  </tr>
</table>
</div>
</div>
