...
<hr>
<strong>Cadastro Classificação | <a href="fcon_classificacao.php">Retornar</a></strong>
<hr>
<form action="ccad_classificacao.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Descrição:</strong></td>
    <td width="450" align="left" valign="top"><input name="fdescricao" type="text" id="fdescricao" size="65" maxlength="65" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Detalhe:</strong></td>
      <td align="left" valign="top"><textarea name="fdetalhe" cols="65" rows="10" id="fdetalhe"></textarea></td>
    </tr>
    <tr>
