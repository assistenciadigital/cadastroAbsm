...
<hr>
<strong>Consulta Cidade | <a href="fcon_cidade.php">Retornar</a> | <a href="fcad_cidade.php">Novo Registro +</a></strong>
<hr>
...
$pega_uf = $_GET[fcidadeuf];
$pega_descricao = $_GET[fdescricao];

$sql = "SELECT * FROM cidade WHERE uf LIKE '$pega_uf%' AND descricao LIKE '$pega_descricao%' ORDER BY uf, descricao";
