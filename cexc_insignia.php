...
$observacao = ("EXC: $data_atual, $hora_atual, insignia: $insignia, Sigla: $sigla, Descricao: $descricao, Instituicao: $instituicao, Hierarquia: $hierarquia, Imagem: $imagem, Usuario: $idusuario_atual - $loginusuario_atual");
...
$sql = "DELETE FROM insignia WHERE insignia=$pega_insignia";
$rs = mysql_query($sql);
