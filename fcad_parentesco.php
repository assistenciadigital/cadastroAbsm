...
<hr>
<strong>Cadastro Parentesco | <a href="fcon_parentesco.php">Retornar</a></strong>
<hr>
<form action="ccad_parentesco.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
