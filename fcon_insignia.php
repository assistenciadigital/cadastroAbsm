...
<hr>
<strong>Consulta Insígnia | <a href="menu.php">Retornar</a> | <a href="fcad_insignia.php">Novo Registro +</a></strong>
<hr>
<form action="fbus_insignia.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
    <strong>Sigla: </strong>
    <input name="fsigla" type="text" id="fsigla" size="10" maxlength="20" />
    <script language="JavaScript"> document.form1.fsigla.focus(); </script>    
    <strong>Descrição: </strong>
    <input name="fdescricao" type="text" id="fdescricao" size="15" maxlength="20" />
    <strong>Instituição: </strong>
    <select name="finstituicao" id="finstituicao">
    <option value=""></option>
    <option value="CBM/MT">CBM/MT</option>
    <option value="PM/MT">PM/MT</option>
...
$sql = "SELECT * FROM insignia ORDER BY hierarquia, sigla";
$rs = mysql_query($sql);
...
<table width="680" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    ...
    <td width="37,5" height="35" align="center" scope="col"></a><a href="fexc_insignia.php?insignia=<?php print $insignia; ?>"><img src="imagem/ico-delete.png" alt="" width="23" height="23"/></a></td>
    </tr>
</table>
<?php } ?>
</div>
