...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="50%" align="left" ><strong>Associação Beneficente de Saúde dos Militares do Estado de MT
		 </strong></td>
         <td width="50%" align="right" ><strong>Codigo Associado: <?php print $pega_cliente; ?></strong></td>
       </tr>
    </table>
<hr>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<div style="color:#009; width:700px; overflow: auto; vertical-align: center;">
<form action="calt_cliente.php" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onsubmit="return validacampos(); return false;">
  ...
  <tr align="left" valign="middle">
    <td><strong>Inclusão:</strong></td>
    <td><strong></strong><input name="fdatainclusao" type="text" id="fdatainclusao" value="<?php print $datadeinclusao; ?>" size="10" /><strong> CNS: </strong><input name="cartaosus" type="text" id="cartaosus" value="<?php print $cartaosus; ?>"/></td>
  </tr>
  <tr align="left" valign="middle">
    <td width="100"><strong>Assistencia:</strong></td>
    <td width="500">      
  ...
  <tr>
    <td width="100" align="left" valign="middle"><strong>Instituição:</strong></td>
    <td width="500" align="left" valign="middle"><strong>
    ...
    </strong><strong> Matricula: </strong><input name="fmatriculasad" type="text" id="fmatriculasad" value="<?php print $matriculasad; ?>" size="11" maxlength="20" /><span class="style1">* formato de 05 dígitos: 99999</span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="100" align="left" valign="middle"><strong>CPF: </strong></td>
    <td width="500" align="left" valign="middle"><strong>
      <input name="fcpf" type="text" id="fcpf" onblur="return verificarcpf(this.value)" value="<?php print $cpf; ?>" size="11" maxlength="11"/><span class="style1">*</span></strong><strong> RG:</strong><input name="frg" type="text" id="frg" value="<?php print $rg; ?>" size="11" maxlength="11" /><span class="style1">*</span></strong><strong> Emissor: </strong><select name="fufrg" id="fufrg">           
          ...
          <option value="SP">SP</option>
          <option value="TO">TO</option>
          </select><span class="style1">*</span></strong><strong> Emissão: </strong><input name="fdataemissaorg" type="text" id="fdataemissaorg" value="<?php print $datadeemissaorg; ?>" size="10" maxlength="10" /><span class="style1">*</span></strong></td>
    </tr>
   </table>
</fieldset>
  ...
  <table width="600" border="0" cellpadding="1" cellspacing="1">
   ...
   <tr align="left" valign="middle">  
      <td width="100"><strong>Estado Civil:</strong></td>
      <td width="500"><strong>
  ...
  <table width="600" border="0" cellpadding="1" cellspacing="1">
   ...
   <tr align="left" valign="middle">  
      <td width="100"><strong>Pai:</strong></td>
      <td width="500"><strong><input name="fpai" type="text" id="fpai" value="<?php print $pai; ?>" size="50" maxlength="100" /></strong></td>
    </tr>
    <tr align="left" valign="middle">
  ...
  <table width="600" border="0" cellpadding="1" cellspacing="1">
    <tr align="left" valign="middle">
      <td width="100"><strong>Profissão:</strong></td>
      <td width="500"><strong>
    ...
    <tr align="left" valign="middle">
      ...
      <td><strong>
        <input name="fcep" type="text" id="fcep" value="<?php print $cep; ?>" size="10" maxlength="10" /><span class="style1">*</span></strong><strong> UF: </strong><strong>
    ...
    <tr align="left" valign="middle">
      <td width="100"><strong>Endereço:</strong></td>
      <td width="500"><strong>
        <label for="fendereco">
	...
	<?php echo "<p style='page-break-after:always'></p>";?>
    <fieldset><legend><strong>Observação:</strong></legend>
    <table width="660" border="0">

    <tr align="left" valign="middle">
      <td width="660" align="left" valign="middle"><label for="fdetalhe"></label>
		<p style="text-align: justify;"><?php //echo $obs1; echo $obs2; echo $obs3; echo $detalhe;?></p>
      </tr>
    </table>
    </fieldset>
	
	    <fieldset><legend><strong>CIENTE E AUTORIZAÇÃO</strong></legend>
    <table width="660" border="0">

    <tr align="left" valign="middle">
      <td width="660" align="left" valign="middle"><label for="fdetalhe"></label>
      <p style="text-align: justify;">1)	<u><b>Declaro estar ciente</b></u> de que a contribuição ou mensalidade autorizada a ser descontada por meio de <u><b>Débito Automático</b></u> e/ou <u><b>Boleto Bancário</b></u> a qual por ventura não vier a ser efetivada, deverá o sócio(a) no prazo de até 05 (cinco) dias úteis quitar a pendência junto ao setor financeiro da ABSM/MT, sob pena de sofrer bloqueio no atendimento e a perda do desconto de 20% (vinte por cento) sobre o valor da contribuição e/ou mensalidade associativa.</p>
	  <p style="text-align: justify;">2)	<u><b>Declaro estar ciente</b></u> de que <u><b>serei excluído</b></u> do quadro de associado, sem direito a qualquer restituição, caso deixe de recolher a contribuição ou mensalidade prevista no Estatuto Social, após 03 (três) meses consecutivos (Estatuto Social da ABSM/MT).<p/>
	  <p style="text-align: justify;">3)	<u><b>Autorizo o desconto</b></u> da contribuição da mensalidade no <u><b>Débito Automático</b></u> da pela Secretária de Gestão do Estado de Mato Grosso (SEGES/MT), via convênio Estado e Câmera Interbancária de Pagamentos (CIP), na denominação da <u><b>Associação da Caixa de Assistência dos Militares</b></u> (CAM), em deferência Assembleia Geral Extraordinária de 12/04/2016, Diário Oficial do Estado de Mato Grosso no: 26.756, página 177.</p>
	  <p style="text-align: justify;">4)	Nestes termos,</p>
	  <p style="text-align: justify;">Pede e Espera Deferimento,</p>
	  <p style="text-align: center;"><?php echo "Cuiabá-MT, ".date('d')."/".date('m'). "/".date('Y')?></p>
	  <br/>
	  <p style="text-align: center;"><?php echo '<b>'.$nome.'</b><br/>CPF '.$cpf?></p>
      </tr>
    </table>
    </fieldset>
</form>
