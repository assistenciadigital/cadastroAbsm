...
<hr>
<strong>Cadastro realizado com sucesso! | <a href="fcon_cidade.php">Retornar</a></strong>
<hr>
<form id="form1" name="form1" method="post" action="">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td width="130" align="left" valign="top"><strong>Cidade:</strong></td>
      <td width="450" align="left" valign="top"><input name="fcidade" type="text" disabled="disabled" id="fcidade" value="<?php print $cidade; ?>" size="2" maxlength="2" readonly="readonly" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="ftipo" type="text" disabled="disabled" id="ftipo" value="<?php print $tipo; ?>" size="1" maxlength="1" readonly="readonly" /></td>
    </tr>
    <tr>
