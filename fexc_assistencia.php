...
<hr>
<strong>Confirma Exclusão  Assistência Médica?  | <a href="fcon_assistencia.php">Retornar</a></strong>
<hr>
<form action="cexc_assistencia.php?assistencia=<?php print $assistencia;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Assistencia:</strong></td>
    <td width="450" align="left" valign="top"><input name="fassistencia" type="text" disabled="disabled" id="fassistencia" value="<?php print $assistencia; ?>" size="2" maxlength="2" />
    </td>
    </tr>
    <tr>
