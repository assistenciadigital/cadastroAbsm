...
<hr>
<div style="color:#009; width:700px; height: 480px; overflow: auto; vertical-align: left;">
...
<div style="color:#009; width:680px; height: 180px; overflow: auto; vertical-align: left;">
<?php
//######### INICIO Paginação
...
$sql = mysql_query("select * from recibo order by recibo LIMIT $inicial, $numreg");

// Serve para contar quantos registros você tem na seua tabela para fazer a paginação
$sql_conta = mysql_query("SELECT * FROM recibo");
...
<table width="640" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
	...
	<?php $sqllistaemitente = "SELECT inscricao as inscricao_emitente, nome_fantasia as nome_fantasia_emitente FROM recibo_emitente WHERE emitente='$pega_emitente'";
		...
		$sqltitular = "SELECT cliente, nome, cpf FROM cliente WHERE status = 'Ativo' and cliente='$pega_destinatario'";
		$rstitular = mysql_query($sqltitular);
		while(list($cliente, $nome, $cpf) = mysql_fetch_row($rstitular)) { ?>
    ...
    <td width="23" align="left" scope="col"><a href="falt_recibo.php?recibo=<?php print $aux['recibo']; ?>"><img src="imagem/ico-refresh.png" alt="" width="23" height="23"/></a><br/>
