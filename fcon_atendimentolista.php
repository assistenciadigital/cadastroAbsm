...
<table width="680" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th width="200" align="left" valign="top" scope="col">
      Pesquisar por:<br/>
        <input name="fcheck" type="checkbox" id="fcheck_1" value="1" checked="checked" onclick="fcheck_2.checked=false"/>
      <label>
    Data Agendado</label><br />
      <label>
        <input name="fcheck" type="checkbox" id="fcheck_2" value="2" onclick="fcheck_1.checked=false"/>
        Data Atendido</label>
      <br />
  </th>
    <th width="240" align="left" valign="top" scope="col">
      ...
      <input name="fdata_inicio" type="text" id="fdata_inicio" value="<?php print date('d/m/Y');?>" size="10" maxlength="10" /><br/><label for="fdata_fim">Data  Final: </label>&nbsp;<input name="fdata_fim" type="text" id="fdata_fim" value="<?php print date('d/m/Y');?>" size="10" maxlength="10" /></th>
    <th width="240" align="right" valign="top" scope="col"><p><br/>
