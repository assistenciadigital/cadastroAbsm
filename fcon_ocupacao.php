...
<hr>
<strong>Consulta Ocupação | <a href="menu.php">Retornar</a> | <a href="fcad_ocupacao.php">Novo Registro +</a></strong>
<hr>
<form action="fbus_ocupacao.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
...
<table width="680" align="left">
  <tr valign="middle">
    <th width="100" height="0" align="left" valign="middle" scope="col"><strong>Ocupação</strong></th>
...
$sql = "SELECT * FROM ocupacao ORDER BY descricao";
$rs = mysql_query($sql);


while(list($ocupacao, $descricao, $data, $hora, $usuario) = mysql_fetch_row($rs)) {
...
<table width="680" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    <td width="100" height="35" align="left" scope="col"><?php print $ocupacao; ?></td>
    ...
    <td width="50" height="35" align="center" scope="col"><a href="falt_ocupacao.php?ocupacao=<?php print $ocupacao; ?>"><img src="imagem/ico-refresh.png" alt="" width="23" height="23"/></a></td>
    <td width="50" height="35" align="center" scope="col"><a href="fexc_ocupacao.php?ocupacao=<?php print $ocupacao; ?>"><img src="imagem/ico-delete.png" alt="" width="23" height="23"/></a></td>
  </tr>
</table>
<?php } ?>
</div>
