...
<hr>
<strong>Consulta Particular / Convenio SUS | <a href="menu.php">Retornar</a></strong>
<hr>
...
$sql = "SELECT particular, nome, classificacao, datanascimento, cpf, data, hora, usuario FROM particular ORDER BY nome";
$rs = mysql_query($sql);


while(list($particular,$classificacao,$nome,$datanascimento,$cpf,$data,$hora,$usuario) = mysql_fetch_row($rs)) {
