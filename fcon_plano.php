...
<hr>
<strong>Consulta Plano | <a href="menu.php">Retornar</a> | <a href="fcad_plano.php">Novo Registro +</a></strong>
<hr>
<form action="fbus_plano.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
...
<tr valign="middle">
    <th width="100" height="0" align="left" valign="middle" scope="col">Plano</th>
...
$sql = "SELECT plano, descricao, detalhe, data, hora, usuario FROM plano ORDER BY descricao";
$rs = mysql_query($sql);


while(list($plano, $descricao, $detalhe, $data, $hora, $usuario) = mysql_fetch_row($rs)) {
...
<table width="680" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    <td width="100" height="35" align="left" scope="col"><?php print $plano; ?></td>
    ...
    <td width="37,5" height="35" align="center" scope="col"><a href="falt_plano.php?plano=<?php print $plano; ?>"><img src="imagem/ico-refresh.png" alt="" width="23" height="23"/></a></td>
    <td width="37,5" height="35" align="center" scope="col"><a href="fexc_plano.php?plano=<?php print $plano; ?>"><img src="imagem/ico-delete.png" alt="" width="23" height="23"/></a></td>
