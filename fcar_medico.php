...
<table width="791" align="left">
  <tr>
  <th height="248" scope="col"><img src="imagem/carteirinhas/carteirinha_medico.png" width="791" height="248" /></th>  </tr>
</table>
<p>&nbsp;</p>
<hr>
<p>&nbsp;</p>
...
<p>Eu, <strong><?php print $nome_titular; ?></strong>, nascido em: <strong><?php print $datanascimentotitular; ?></strong>, rebeci a carteira de indentificação de associado, emitida em: <strong><?php print $data_atual; ?></strong>, com vencimento em: <strong><?php print $data_validade; ?></strong>, na condição de: <strong><?php print $produto_regulamentado; ?></strong>, para atendimento ambulatorial (<strong><?php print $acomodacao; ?></strong>), neste <strong>HM - Hospital Militar</strong> e <strong>Conveniados</strong>, dando ciência aos termos abaixo:</p>
...
<div id="apDiv3"><strong>HM - Hospital Militar - SOMENTE MÉDICO<br />ABSM - Associação Beneficente de Saúde dos Militares do Estado de Mato Grosso</strong></div>
<?php } ?>
</body>
</html>