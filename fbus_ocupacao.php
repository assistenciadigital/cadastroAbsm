...
<hr>
<strong>Consulta Ocupação | <a href="fcon_ocupacao.php">Retornar</a> | <a href="fcad_ocupacao.php">Novo Registro +</a></strong>
<hr>
...
$sql = "SELECT * FROM ocupacao WHERE descricao LIKE '$pega_descricao%' ORDER BY descricao";
$rs = mysql_query($sql);
