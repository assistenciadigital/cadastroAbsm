...
<hr>
<strong>Cadastro Tipo | <a href="fcon_tipo.php">Retornar</a></strong>
<hr>
<form action="ccad_tipo.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><label for="ftitular"></label>
        ...
        <strong>* S = SIM ou N = NAO</strong></td>
    </tr>
    <tr>
