...
<hr>
<strong>Cadastro  Particular / Convênio SUS  | <a href="fcon_particular.php">Retornar</a></strong>
<hr>
<div style="color:#009; width:700px; height:390px; overflow: auto; vertical-align: center;">
<form action="ccad_particular.php" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onsubmit="return validacampos(); return false;">

  <fieldset>
  <legend><strong>Dados do Paciente:</strong></legend>
  <table width="580" border="0" cellpadding="1" cellspacing="1">
  <tr>
    <td width="130" align="left" valign="middle"><strong>Classificação:</strong></td>
    <td width="450" align="left" valign="middle">  <select name="fclassificacao" id="fclassificacao">
      <option value=""></option>
      <?php
 		 include("requerido/conexao.php");
         $sqlclassificacao = "SELECT * FROM classificacao where titular = 'S' AND associado = 'N' ORDER BY descricao";
