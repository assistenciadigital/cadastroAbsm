...
<hr>
<p> <strong>Cadastro realizado com sucesso! | <a href="fcon_profissao.php">Retornar</a></strong>
<hr>
<form id="form1" name="form1" method="post" action="">
  ...
  <tr>
    ...
    <td width="450" align="left" valign="top"><input name="fprofissao" type="text" disabled="disabled" id="fprofissao" value="<?php print $profissao; ?>" size="2" maxlength="2" readonly="readonly" />
    </td>
    </tr>
    <tr>
