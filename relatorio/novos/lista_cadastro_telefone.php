...
function limpa() {
  ...
  <body>
	...
	<div class="row">
        ...
        <hr>
        <form action="lista_cadastro_telefone.php" name="frmlista" id="frmlista" method="post" enctype="multipart/form-data">
<p>RELATORIO CADASTRO - SOMENTE TITULARES<p/>
        ...
        <strong><a href="relatorio_cadastro_telefone.php?status=<?php echo $_POST['status']?>&classificacao=<?php echo $_POST['classificacao']?>&tipo=<?php echo $_POST['tipo']?>&assistencia=<?php echo $_POST['assistencia']?>" target="_blank">
