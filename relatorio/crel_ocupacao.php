...
<table width="700" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="700" valign="middle">Relatorio: OCUPACAO</td>
  </tr>
</table>
<br/>
<table width="700" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <th colspan="3" align="center" valign="middle">OCUPACAO</th>
  </tr>
  <tr>
    <th width="100" align="center" valign="middle">OCUPACAO</th>
    <th width="500" align="left">DESCRICAO</th>
    <th width="100" align="left">DATA</th>
  </tr>
  </table>
 <?php 
$sql = "SELECT ocupacao, descricao, data, hora, usuario FROM ocupacao ORDER BY descricao";
$rs = mysql_query($sql);
$soma = 0;
...
?>
 ...
 <table width="700" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100" align="center" valign="middle"><?php print $ocupacao; ?></td>
