...
<table width="700" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <th colspan="5" align="center" valign="middle">PAGAMENTO</th>
  </tr>
  <tr>
    <th width="60" align="center" valign="middle">RECIBO</th>
    <th width="100" align="center" valign="middle">DATA</th>
    <th width="100">EMITENTE</th>
    <th width="340" align="left">FAVORECIDO / DESCRICAO</th>
    <th width="100" align="right">VALOR R$</th>
  </tr>
</table>
 <?php 
  $sql_recibo = "SELECT recibo,valor,emitente,referencia,destinatario,tipo,titular,mes_ano,descricao,data,hora,usuario from recibo where (emitente > '2' and recibo BETWEEN '$pega_recibo_inicial' AND '$pega_recibo_final' and data BETWEEN '$pega_periodo_inicial' AND '$pega_periodo_final') order by data, hora, destinatario";
