...
<table width="700" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <th colspan="3" align="center" valign="middle">RELACAO ASSOCIADOS ABSM</th>
  </tr>
  <tr>
...
while(list($codigo_cliente, $codigomilitar, $nome_cliente, $cpf_cliente, $assistencia, $descricao_status, $codigo_classificacao, $descricao_classificacao, $codigo_tipo, $descricao_tipo, $data, $hora, $usuario) = mysql_fetch_row($rs)) {
...
?>
 ...
 <table width="700" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="150" align="center" valign="middle"><?php print 'N: '.$codigo_cliente.'<br/>A: '.$codigomilitar.'<br/>CPF:'.$cpf_cliente;?></td>
