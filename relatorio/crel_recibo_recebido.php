...
<table width="700" border="1" cellspacing="0" cellpadding="0">
 ...
 <?php 
  $sql_recibo = "SELECT recibo,valor,emitente,referencia,destinatario,tipo,titular,mes_ano,descricao,data,hora,usuario from recibo where emitente > '2' order by emitente, data";
