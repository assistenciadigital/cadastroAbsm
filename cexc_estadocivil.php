...
$observacao = ("EXC: $data_atual, $hora_atual, Estado civil: $estadocivil, Descricao: $descricao, Detalhe: $detalhe, Usuario: $idusuario_atual - $loginusuario_atual");
...
$sql = "DELETE FROM estadocivil WHERE estadocivil=$pega_estadocivil";
$rs = mysql_query($sql);
