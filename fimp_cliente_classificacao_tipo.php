...
header("Location:relatorio/crel_cliente_classificacao_tipo.php?classificacao=$classificacao&tipo=$tipo&status=$status");
}
?>
<div id="tudo">
<div id="conteudo">
...
<hr>
<strong>Impressão de Cliente x Classificação x Tipo</strong>
<hr>
