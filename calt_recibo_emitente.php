...
$nivelusuario_atual = base64_decode($_SESSION['nivel_usuario']);
  ...
  $observacao = ("ALT: $data_atual, $hora_atual, Emitente: $pega_emitente, Inscricao: $inscricao, Razao: $razao_social, Fantasia: $nome_fantasia, Endereco: $endereco, Bairro: $bairro, Cidade: $cidade, UF: $uf, CEP: $cep, Usuario: $idusuario_atual - $loginusuario_atual");
  ...
  $sql = "UPDATE recibo_emitente SET inscricao='$inscricao', razao_social='$razao_social', nome_fantasia='$nome_fantasia', endereco='$endereco', bairro='$bairro', cidade='$cidade', uf='$uf', cep='$cep', data='$data_atual', hora='$hora_atual', usuario='$loginusuario_atual' WHERE emitente='$pega_emitente'";
  $rs = mysql_query($sql);
