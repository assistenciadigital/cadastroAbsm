...
<hr>
<strong>Consulta Parentesco | <a href="fcon_parentesco.php">Retornar</a> | <a href="fcad_parentesco.php">Novo Registro +</a></strong>
<hr>
...
$pega_grau = $_GET[fgrau];

$sql = "SELECT * FROM parentesco WHERE descricao LIKE '$pega_descricao%' AND grau LIKE '$pega_grau%' ORDER BY grau, descricao";
$rs = mysql_query($sql);
