...
<hr>
<strong>Confirma Alteração Classificação? | <a href="fcon_classificacao.php">Retornar</a></strong>
<hr>
<form action="calt_classificacao.php?classificacao=<?php print $classificacao;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
<table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Classificação:</strong></td>
    <td width="450" align="left" valign="top"><input name="fclassificacao" type="text" disabled="disabled" value="<?php print $classificacao; ?>" size="2" maxlength="2" readonly="readonly" /></td>
  </tr>
  <tr>
    <td align="left" valign="top"><strong>Descrição:</strong></td>
    <td align="left" valign="top"><input name="fdescricao" type="text" value="<?php print $descricao; ?>" size="65" maxlength="65" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top"><label for="ftitular"></label>
