...
$observacao = ("EXC: $data_atual, $hora_atual, Cidade: $cidade, UF: $uf, Descricao: $descricao, Usuario: $idusuario_atual - $loginusuario_atual");
...
$sql = "DELETE FROM cidade WHERE cidade=$pega_cidade";
$rs = mysql_query($sql);
