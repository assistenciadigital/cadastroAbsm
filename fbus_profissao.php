...
<hr>
<strong>Consulta Profissao | <a href="fcon_profissao.php">Retornar</a> | <a href="fcad_profissao.php">Novo Registro +</a></strong>
<hr>
<table width="680" align="left">
  <tr valign="middle">
    <th width="100" height="0" align="left" valign="middle" scope="col"><strong>profissao</strong></th>
...
$sql = "SELECT * FROM profissao WHERE descricao LIKE '$pega_descricao%' ORDER BY descricao";
$rs = mysql_query($sql);
...
<table width="680" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    <td width="100" height="35" align="left" scope="col"><?php print $profissao; ?></td>
    ...
    <td width="50" height="35" align="center" scope="col"><a href="falt_profissao.php?profissao=<?php print $profissao; ?>"><img src="imagem/ico-refresh.png" alt="" width="23" height="23"/></a></td>
    <td width="50" height="35" align="center" scope="col"><a href="fexc_profissao.php?profissao=<?php print $profissao; ?>"><img src="imagem/ico-delete.png" alt="" width="23" height="23"/></a></td>
  </tr>
</table>
<?php } ?>
</div>
