...
<hr>
<strong>Cadastro Usuário | <a href="fcon_usuario.php">Retornar</a></strong>
<hr>
<form action="ccad_usuario.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Login:</strong></td>
    <td width="450" align="left" valign="top"><input name="flogin" type="text" id="flogin" size="20" maxlength="20" />
    </td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Senha:</strong></td>
      <td align="left" valign="top"><input name="fsenha" type="password" id="fsenha" size="16" maxlength="11" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Nome:</strong></td>
      <td align="left" valign="top"><input name="fnome" type="text" id="fnome" size="50" maxlength="50" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Nível:</strong></td>
