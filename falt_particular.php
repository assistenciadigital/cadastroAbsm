...
<hr>
<strong>Confirma Alteração  Particular / Convênio SUS ? | <a href="fcon_particular.php">Retornar</a></strong>
<hr>
<form action="calt_particular.php?particular=<?php print $particular;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
<div style="color:#009; width:700px; height:390px; overflow: auto; vertical-align: center;">
<form action="calt_particular.php?particular=<?php print $particular;?>" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onsubmit="return validacampos(); return false;">

  <fieldset>
    <legend><strong>Dados do Paciente:</strong></legend>
  <table width="580" border="0" cellpadding="1" cellspacing="1">
  <tr align="left" valign="middle">
    <td width="130"><strong>Paciente:</strong></td>
    <td width="450"><strong><input name="fparticular" type="text" disabled="disabled" value="<?php print $pega_particular; ?>" size="10" maxlength="10" readonly="readonly" />
      </strong></td>
  </tr>
  <tr>
    <td align="left" valign="middle"><strong>Classificação:</strong></td>
    <td align="left" valign="middle">  
      <select name="fclassificacao" id="fclassificacao">           
        <?php 
        ...
        <option value=""></option>
        <?php 
		$sqlclassificacaonew = "select * from classificacao WHERE titular = 'S' AND associado = 'N' order by descricao";
  ...
  <tr>
    ...
    <td align="left" valign="middle"><select name="fformapagto" id="fformapagto">
      <?php 
...
Res.:
    ...
    <tr align="left" valign="middle">
      ...
      <td width="450" align="left" valign="middle"><label for="fdetalhe"></label>
        <textarea name="fdetalhe" id="fdetalhe" cols="50" rows="5"><?php print $detalhe; ?></textarea></td>
      </tr>
    </table>
    </fieldset>
