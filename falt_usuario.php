...
<hr>
<strong>Confirma Alteração Usuário? | <a href="fcon_usuario.php">Retornar</a></strong>
<hr>
<form action="calt_usuario.php?idusuario=<?php print $idusuario;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <tr>
    ...
    <td align="left" valign="top"><input name="flogin" type="text" disabled="disabled" id="flogin" value="<?php print $login; ?>" size="20" maxlength="20" readonly="readonly" /><script language="JavaScript"> document.form1.flogin.focus(); </script></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Senha:</strong></td>
      <td align="left" valign="top"><input name="fsenha" type="password" disabled="disabled" id="fsenha" value="<?php print (base64_decode($senha)); ?>" size="16" readonly="readonly" />
      </td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Nome:</strong></td>
      <td align="left" valign="top"><input name="fnome" type="text" id="fnome" value="<?php print $nome; ?>" size="50" maxlength="50" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Nivel:</strong></td>
      <td align="left" valign="top"><select name="fnivel" id="fnivel">
        ...
        <option value="6">SUS</option>
      </select></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Ativo:</strong></td>
      <td align="left" valign="top"><select name="fativo" id="fativo">
    ...
    <tr>
      ...
      <td align="left" valign="top"><select name="fsms" id="fsms">
