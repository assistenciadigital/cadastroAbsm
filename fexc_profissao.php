...
<hr>
<strong>Confirma Exclusão Profissao?  | <a href="fcon_profissao.php">Retornar</a></strong>
<hr>
<form action="cexc_profissao.php?profissao=<?php print $profissao;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellpadding="1" cellspacing="1">
    <tr>
      <td width="130" align="left" valign="top"><strong>Profissao:</strong></td>
      <td width="450" align="left" valign="top"><input name="fprofissao" type="text" disabled="disabled" id="fprofissao" value="<?php print $profissao; ?>" size="2" maxlength="2" />
    </td>
    </tr>
    <tr>
