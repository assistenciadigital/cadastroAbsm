...
$observacao = ("ALT: $data_atual, $hora_atual, Ocupacao: $ocupacao, Descricao: $descricao, Usuario: $idusuario_atual - $loginusuario_atual");
  ...
  $sql = "UPDATE ocupacao SET descricao='$descricao',data='$data_atual',hora='$hora_atual',usuario='$loginusuario_atual' WHERE ocupacao=$pega_ocupacao";
  $rs = mysql_query($sql);
