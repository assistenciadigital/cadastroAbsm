...
<hr>
<strong>Consulta Estado Civil | <a href="menu.php">Retornar</a> | <a href="fcad_estadocivil.php">Novo Registro +</a></strong>
<hr>
<form action="fbus_estadocivil.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
...
<tr valign="middle">
    <th width="100" height="0" align="left" valign="middle" scope="col">Estado Civil</th>
...
$sql = "SELECT * FROM estadocivil ORDER BY descricao";
$rs = mysql_query($sql);


while(list($estadocivil, $descricao, $detalhe, $data, $hora, $usuario) = mysql_fetch_row($rs)) {
...
<table width="680" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    <td width="100" height="35" align="left" scope="col"><?php print $estadocivil; ?></td>
    ...
    <td width="37,5" height="35" align="center" scope="col"><a href="falt_estadocivil.php?estadocivil=<?php print $estadocivil; ?>"><img src="imagem/ico-refresh.png" alt="" width="23" height="23"/></a></td>
    <td width="37,5" height="35" align="center" scope="col"><a href="fexc_estadocivil.php?estadocivil=<?php print $estadocivil; ?>"><img src="imagem/ico-delete.png" alt="" width="23" height="23"/></a></td>
