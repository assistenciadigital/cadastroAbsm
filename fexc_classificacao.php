...
<hr>
<strong>Confirma Exclusão Classificação?  | <a href="fcon_classificacao.php">Retornar</a></strong>
<hr>
<form action="cexc_classificacao.php?classificacao=<?php print $classificacao;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Classificação:</strong></td>
    <td width="450" align="left" valign="top"><input name="fclassificacao" type="text" disabled="disabled" id="fclassificacao" value="<?php print $classificacao; ?>" size="2" maxlength="2" />
    </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="ftitular" type="text" disabled="disabled" id="ftitular" value="<?php print $titular; ?>" size="2" maxlength="2" /></td>
    </tr>
    <tr>
