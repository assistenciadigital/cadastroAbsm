...
<hr>
<strong>Consulta  Particular / Convênio SUS  | <a href="menu.php">Retornar</a> | <a href="fcad_particular.php">Novo Registro +</a> | <a href="crel_particular.php" target="_blank">Relação</a></strong>
<hr>
<form action="fbus_particular.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
  <strong>Nome: </strong>
