...
<hr>
<strong>Confirma Exclusão  Cidade?  | <a href="fcon_cidade.php">Retornar</a></strong>
<hr>
<form action="cexc_cidade.php?cidade=<?php print $cidade;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong> Cidade:</strong></td>
    <td width="450" align="left" valign="top"><input name="fcidade" type="text" disabled="disabled" id="fcidade" value="<?php print $cidade; ?>" size="4" maxlength="4" />
    </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="fdescricao" type="text" disabled="disabled" id="fdescricao" value="<?php print $descricao; ?>" size="50" maxlength="50" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Tipo:</strong></td>
      <td align="left" valign="top"><input name="ftipo" type="text" disabled="disabled" id="ftipo" value="<?php print $tipo; ?>" size="1" maxlength="1" /></td>
    </tr>
    <tr>
