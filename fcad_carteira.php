...
$sql = "SELECT cliente, titular, nome, cpf, datanascimento, datainclusao, classificacao, assistencia, status, data, hora, usuario FROM cliente WHERE cliente ='$pega_cliente'";
$rs = mysql_query($sql);

list($cliente, $titular, $nome, $cpf, $datanascimento, $datainclusao, $classificacao, $assistencia, $status, $data, $hora, $usuario) = mysql_fetch_row($rs);
...
$sqltitular = "SELECT cliente as codigo_titular, nome as nome_titular, cpf as cpf_titular, datanascimento as datanascimento_titular, datainclusao as datainclusao_titular, titular FROM cliente WHERE cliente ='$pega_titular'";
$rstitular = mysql_query($sqltitular);
list($codigo_titular, $nome_titular, $cpf_titular, $datanascimento_titular, $datainclusao_titular, $titular) = mysql_fetch_row($rstitular);	
	$envia_cliente = $codigo_titular;
	$envia_nome = $nome_titular;
	$envia_cpf = $cpf_titular;
...
<form action="ccad_carteira.php" target="_blank" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onsubmit="return validacampos(); return false;">
  ...
  <tr>
    ...
    <td align="left" valign="middle"><strong>
      <input name="fcpftitular" type="text" id="fcpftitular" value="<?php print $envia_cpf; ?>" size="30" maxlength="50" readonly="readonly" />
    </strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><strong>CPF:</strong></td>
    <td align="left" valign="middle"><strong>
      <input name="fcpfdependente" type="text" id="fcpfdependente" value="<?php print $cpf; ?>" size="50" maxlength="150" readonly="readonly" />
    </strong></td>
    </tr>	
  <tr>
    <td align="left" valign="middle"><strong>Dt Nascimento:</strong></td>
