...
<hr>
<strong>Consulta Profissao | <a href="menu.php">Retornar</a> | <a href="fcad_profissao.php">Novo Registro +</a></strong>
<hr>
<form action="fbus_profissao.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
