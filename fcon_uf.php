...
<hr>
<strong>Consulta UF | <a href="menu.php">Retornar</a> | <a href="fcad_uf.php">Novo Registro +</a></strong>
</p>
</p>
<hr>
<form action="fbus_uf.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
<strong>Sigla: </strong>
<input name="fsigla" type="text" id="fsigla" size="2" maxlength="2" />
<script language="JavaScript"> document.form1.fsigla.focus(); </script>
<strong>Descrição: </strong>
<input name="fdescricao" type="text" id="fdescricao" size="20" maxlength="20" />
<strong>Capital: </strong>
<input name="fcapital" type="text" id="fcapital" size="20" maxlength="20" />
