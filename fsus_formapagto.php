...
<hr>
<strong>Cadastro realizado com sucesso! | <a href="fcon_formapagto.php">Retornar</a></strong>
<hr>
<form id="form1" name="form1" method="post" action="">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
    <tr>
      ...
      <td width="450" align="left" valign="top"><input name="fformapagto" type="text" disabled="disabled" id="fformapagto" value="<?php print $formapagto; ?>" size="2" maxlength="2" readonly="readonly" /></td>
    </tr>
    <tr>
