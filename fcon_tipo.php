...
<hr>
<strong>Consulta Tipo | <a href="menu.php">Retornar</a> | <a href="fcad_tipo.php">Novo Registro +</a></strong>
<hr>
<form action="fbus_tipo.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
...
<table width="680" align="left">
  <tr valign="middle">
    <th width="100" height="0" align="center" valign="middle" scope="col"><strong>Tipo</strong></th>
...
$sql = "SELECT tipo.tipo as tipo, classificacao.descricao AS classificacao, tipo.descricao as descricao, tipo.titular as titular, tipo.data as data, tipo.hora as hora, tipo.usuario as usuario FROM classificacao INNER JOIN tipo ON classificacao.classificacao = tipo.classificacao ORDER BY classificacao, descricao";
$rs = mysql_query($sql);
...
<table width="680" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    <td width="100" height="35" align="center" scope="col"><?php print $tipo; ?></td>
    <td width="380" height="35" align="left" scope="col">Classificação: <?php print $classificacao; ?><br/>Tipo: <?php print $descricao; ?><br/>Titular? <?php print $titular; ?></td>
