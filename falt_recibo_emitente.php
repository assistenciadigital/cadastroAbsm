...
<hr>
<strong>Alteração Emitente Recibo | <a href="fcad_recibo_emitente.php">Retornar</a></strong>
<hr>
<form action="calt_recibo_emitente.php?emitente=<?php print $pega_emitente;?>" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onsubmit="return validacampos(); return false;">
  <table width="680" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td align="left"><strong>Emitente: </strong></td>
      <td align="left"><strong>
      <input name="femitente" type="text" disabled="disabled" id="femitente" onblur="return verificarcpf(this.value)" value="<?php print $pega_emitente; ?>" size="10" maxlength="10" readonly="readonly"/>
      </strong></td>
    </tr>
    <tr>
      <td width="180" align="left"><strong>CNPJ: </strong></td>
