...
<hr>
<strong>Consulta Bairro | <a href="fcon_bairro.php">Retornar</a> | <a href="fcad_bairro.php">Novo Registro +</a></strong>
<hr>
...
$pega_uf = $_GET[fuf];
$pega_cidade = $_GET[fcidade];
$pega_descricao = $_GET[fdescricao];

#$sql = "SELECT * FROM bairro WHERE descricao LIKE '$pega_descricao%' ORDER BY descricao";
...
FROM cidade INNER JOIN bairro ON cidade.cidade = bairro.cidade WHERE cidade.uf = '$pega_uf' AND bairro.cidade = '$pega_cidade' AND bairro.descricao LIKE '$pega_descricao%' ORDER BY cidade.uf, cidade.descricao, bairro.descricao";
$rs = mysql_query($sql);
