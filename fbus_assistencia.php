...
<hr>
<strong>Consulta Assistência Médica | <a href="fcon_assistencia.php">Retornar</a> | <a href="fcad_assistencia.php">Novo Registro +</a></strong>
<hr>
<table width="680" align="left">
  <tr valign="middle">
    <th width="100" height="0" align="left" valign="middle" scope="col">Assistência</th>
...
$sql = "SELECT * FROM assistencia WHERE descricao LIKE '$pega_descricao%' ORDER BY descricao";
$rs = mysql_query($sql);
