...
<hr>
<strong>Usuário: </strong><?php print strtoupper($idusuario_atual); ?> | <?php print strtoupper($loginusuario_atual); ?> | <?php print strtoupper($nomeusuario_atual); ?>
<hr>
<strong>Consulta Assistência Médica | <a href="menu.php">Retornar</a> | <a href="fcad_assistencia.php">Novo Registro +</a></strong>
<hr>
<form action="fbus_assistencia.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
...
<tr valign="middle">
    <th width="100" height="0" align="center" valign="middle" scope="col">Assistência</th>
...
$sql = "SELECT * FROM assistencia ORDER BY descricao";
$rs = mysql_query($sql);


while(list($assistencia, $descricao, $detalhe, $data, $hora, $usuario) = mysql_fetch_row($rs)) {
...
<table width="680" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    <td width="100" height="35" align="left" scope="col"><?php print $assistencia; ?></td>
    ...
    <td width="37,5" height="35" align="center" scope="col"><a href="falt_assistencia.php?assistencia=<?php print $assistencia; ?>"><img src="imagem/ico-refresh.png" alt="" width="23" height="23"/></a></td>
    <td width="37,5" height="35" align="center" scope="col"><a href="fexc_assistencia.php?assistencia=<?php print $assistencia; ?>"><img src="imagem/ico-delete.png" alt="" width="23" height="23"/></a></td>
