...
$observacao = ("EXC: $data_atual, $hora_atual, UF: $uf, Sigla: $sigla, Descricao: $descricao, Capital: $capital, Imagem: $imagem, Usuario: $idusuario_atual - $loginusuario_atual");
...
$sql = "DELETE FROM uf WHERE uf=$pega_uf";
$rs = mysql_query($sql);
