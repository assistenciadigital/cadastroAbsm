...
$observacao = ("EXC: $data_atual, $hora_atual, ID Usuario: $idusuario, Login: $login, Nome: $nome, Nivel: $nivel, Ativo: $ativo, Envia SMS? $sms, Usuario: $idusuario_atual - $loginusuario_atual");
...
$sql = "DELETE FROM usuario WHERE idusuario=$pega_idusuario";
$rs = mysql_query($sql);
