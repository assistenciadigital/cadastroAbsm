...
<hr>
<p> <strong>Cadastro realizado com sucesso! | <a href="fcon_parentesco.php">Retornar</a></strong>
<hr>
<form id="form1" name="form1" method="post" action="">
  ...
  <tr>
    ...
    <td width="450" align="left" valign="top"><input name="fparentesco" type="text" disabled="disabled" id="fparentesco" value="<?php print $parentesco; ?>" size="2" maxlength="2" readonly="readonly" />
    </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="fgrau" type="text" disabled="disabled" id="fgrau" value="<?php print $grau; ?>" size="2" maxlength="2" readonly="readonly" /></td>
    </tr>
    <tr>
