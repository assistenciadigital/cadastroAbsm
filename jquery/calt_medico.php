...
$nivelusuario_atual = base64_decode($_SESSION['nivel_usuario']);
  ...
  $observacao = ("ALT: $data_atual, $hora_atual, Medico: $pega_medico, Especialidade: $especialidade, Conselho: $conselho, Área: $area, CPF: $cpf, Nome: $nome, Endereco: $endereco, Bairro: $bairro, Cidade: $cidade, UF: $uf, CEP: $cep, Observacao: $descricao, Usuario: $idusuario_atual - $loginusuario_atual");
  ...
  $sql = "UPDATE medico SET cpf='$cpf', especialidade='$especialidade', conselho='$conselho', area='$area',nome='$nome',endereco='$endereco', bairro='$bairro', cidade='$cidade', uf='$uf', cep='$cep', descricao='$descricao',data='$data_atual', hora='$hora_atual', usuario='$loginusuario_atual' WHERE medico='$pega_medico'";
  $rs = mysql_query($sql);
