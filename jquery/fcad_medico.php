...
$sqlmedico = "SELECT medico,cpf,nome,cep,endereco,uf,cidade,bairro,descricao,data,hora,usuario FROM medico";
$rsmedico = mysql_query($sqlmedico);


while(list($medico,$cpf,$nome,$cep,$endereco,$uf,$cidade,$bairro,$descricao,$data,$hora,$usuario) = mysql_fetch_row($rsmedico)) {
...
<table width="640" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    <td width="100" height="35" align="center" valign="middle" scope="col"><strong><?php print $medico; ?></strong></td>
    <td width="437" height="35" align="left" scope="col"><strong><?php print $cpf; ?></strong> | <strong><?php print $nome; ?></strong></td>
