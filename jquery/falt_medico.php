...
$sql = "SELECT medico,especialidade,conselho,area,cpf,nome,cep,endereco,uf,cidade,bairro,descricao,data,hora,usuario from medico WHERE medico='$pega_medico'";

$rs = mysql_query($sql);

list($medico,$especialidade,$conselho,$area,$cpf,$nome,$cep,$endereco,$uf,$cidade,$bairro,$descricao_medico,$data,$hora,$usuario) = mysql_fetch_row($rs);
