...
<hr>
<strong>Cadastro Área Médica / Odontologia | <a href="fcon_area.php">Retornar</a></strong>
<hr>
<form action="ccad_area.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><textarea name="fdetalhe" cols="65" rows="5" id="fdetalhe"></textarea></td>
    </tr>
    <tr>
