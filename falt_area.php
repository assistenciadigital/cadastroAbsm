...
$sql = "SELECT area,descricao,especialidade,detalhe,data,hora,usuario FROM area WHERE area=$pega_area";
$rs = mysql_query($sql);
...
<hr>
<strong>Confirma Alteração Área Médica / Odontologia? | <a href="fcon_area.php">Retornar</a></strong>
<hr>
<form action="calt_area.php?area=<?php print $area;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
<table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Área:</strong></td>
    <td width="450" align="left" valign="top"><input name="farea" type="text" disabled="disabled" value="<?php print $area; ?>" size="2" maxlength="2" readonly="readonly" /></td>
  </tr>
  <tr>
    ...
    <td align="left" valign="top"><strong>
      <select name="fespecialidade" id="fespecialidade">
        ...
        <option value="O">ODONTOLOGICO</option>
      </select>
    </strong></td>
  </tr>
  <tr>
