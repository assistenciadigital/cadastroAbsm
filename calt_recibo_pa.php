...
//  recibo,valor,emitente,referencia,destinatario,tipo,titular,mes_ano,descricao,data,hora,usuario
  
  $observacao = ("ALT: $data_atual, $hora_atual, Recibo: $pega_recibo, Emitente: $emitente, Destinatario: $destinatario / $tipo, Referencia: $referencia, Titular: $titular, Mes/Ano: $mes_ano, Descricao: $descricao, Usuario: $idusuario_atual - $loginusuario_atual");
  ...
  $sql = "UPDATE recibo SET valor='$valor', emitente='$emitente', referencia='$referencia', destinatario='$destinatario', tipo='$tipo', titular='$titular', mes_ano='$mes_ano', descricao='$descricao', data='$data_atual', hora='$hora_atual', usuario='$loginusuario_atual' WHERE recibo='$pega_recibo'";
  $rs = mysql_query($sql);
