...
<hr>
<strong>Cadastro Insígnia | <a href="fcon_insignia.php">Retornar</a></strong>
<hr>
<form action="ccad_insignia.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Sigla:</strong></td>
    <td width="450" align="left" valign="top"><input name="fsigla" type="text" id="fsigla" size="20" maxlength="20" />
    </td>
    </tr>
    <tr>
      ...
      <select name="fhierarquia" id="fhierarquia">
        <option value=""></option>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="fdescricao" type="text" size="30" maxlength="30" /></td>
    </tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="fimagem" type="file" size="65" maxlength="255" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="fusuario" type="text" disabled="disabled" value="<?php print $loginusuario_atual; ?>" size="20" maxlength="20" readonly="readonly" /></td>
    </tr>
    <tr>
      <td align="left" valign="top">&nbsp;</td>
      <td align="left" valign="top"><input type="submit" name="fok" value="OK" /></td>
    </tr>
  </table>
</form>
<hr>
