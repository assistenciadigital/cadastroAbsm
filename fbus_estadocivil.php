...
<hr>
<strong>Consulta Estado Civil | <a href="fcon_estadocivil.php">Retornar</a> | <a href="fcad_estadocivil.php">Novo Registro +</a></strong>
<hr>
...
$sql = "SELECT * FROM estadocivil WHERE descricao LIKE '$pega_descricao%' ORDER BY descricao";
$rs = mysql_query($sql);
