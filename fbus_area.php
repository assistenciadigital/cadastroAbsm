...
<hr>
Consulta Área Médica / Odontologia | <a href="fcon_area.php">Retornar</a> | <a href="fcad_area.php">Novo Registro +</a></strong>
<hr>
...
$sql = "SELECT area,especialidade,descricao,detalhe,data,hora,usuario FROM area WHERE descricao LIKE '$pega_descricao%' ORDER BY descricao";
$rs = mysql_query($sql);


while(list($area,$especialidade,$descricao,$detalhe,$data,$hora,$usuario) = mysql_fetch_row($rs)) {
