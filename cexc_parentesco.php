...
$observacao = ("EXC: $data_atual, $hora_atual, Parentesco: $parentesco, Descricao: $descricao, Grau: $grau, Usuario: $idusuario_atual - $loginusuario_atual");
...
$sql = "DELETE FROM parentesco WHERE parentesco=$pega_parentesco";
$rs = mysql_query($sql);
