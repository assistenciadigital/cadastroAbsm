...
if(document.cadastro.finscricao.value=="")
	...
	if(document.cadastro.fnome_fantasia.value=="")
	{
...
<hr>
<strong>Cadastro Emitente Recibo | <a href="menu.php">Retornar</a></strong>
<hr>
<div style="color:#009; width:700px; height: 500px; overflow: auto; vertical-align: left;">
<form action="ccad_recibo_emitente.php" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onsubmit="return validacampos(); return false;">
<table width="680" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="180" align="left"><strong>CNPJ:
...
<tr valign="middle">
    <th width="100" height="0" align="center" valign="middle" scope="col">Emitente</th>
...
$sqlrecibo_emitente = "SELECT emitente,inscricao,razao_social,nome_fantasia,cep,endereco,uf,cidade,bairro,data,hora,usuario FROM recibo_emitente";
$rsrecibo_emitente = mysql_query($sqlrecibo_emitente);


while(list($emitente,$inscricao,$razao_social,$nome_fantasia,$cep,$endereco,$uf,$cidade,$bairro,$data,$hora,$usuario) = mysql_fetch_row($rsrecibo_emitente)) {
...
<table width="640" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    <td width="100" height="35" align="center" valign="middle" scope="col"><strong><?php print $emitente; ?></strong></td>
    ...
    <td width="23" align="left" scope="col"><a href="falt_recibo_emitente.php?emitente=<?php print $emitente; ?>"><img src="imagem/ico-refresh.png" alt="" width="23" height="23"/></a><br/>
      <a href="cexc_recibo_emitente.php?emitente=<?php print $emitente; ?>"><img src="imagem/ico-delete.png" alt="" width="23" height="23" onclick="return confirm('Deseja excluir?')";/></a></td>
    </tr>
</table>
<?php } ?>
</div>
