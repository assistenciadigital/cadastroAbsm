...
$sql = "SELECT cliente, nome, cpf, datanascimento, classificacao, tipo FROM cliente where status = 'Ativo' and classificacao = 1 and tipo = 2 ORDER BY nome";
$rs = mysql_query($sql);
?>
<?php
...
$pdf->SetY("-2");
		...
		$pdf-> Cell(0,5,'Socio Efetivo Ativos - PM',0,1);
		$pdf-> Ln(4); #pula 4 linhas
		...
		$pdf-> Output("relatorio_titular_ativos_pm.pdf");
?>  
<script>window.open('relatorio_titular_ativos_pm.pdf'); </script>
</body>
</html>