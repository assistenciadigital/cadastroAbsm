...
<hr>
<p> <strong>Cadastro realizado com sucesso! | <a href="fcon_bairro.php">Retornar</a></strong>
<hr>
<form id="form1" name="form1" method="post" action="">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Bairro:</strong></td>
    <td width="450" align="left" valign="top"><input name="fbairro" type="text" disabled="disabled" id="fbairro" value="<?php print $bairro; ?>" size="6" maxlength="6" readonly="readonly" />
      </td>
  </tr>
    <tr>
      <td align="left" valign="top"><strong>UF:</strong></td>
      <td align="left" valign="top"><input name="fuf" type="text" disabled="disabled" id="fuf" value="<?php print $uf; ?>" size="2" maxlength="2" readonly="readonly" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Cidade:</strong></td>
      <td align="left" valign="top"><input name="fcidade" type="text" disabled="disabled" id="fcidade" value="<?php print $cidade; ?>" size="30" maxlength="30" readonly="readonly" /></td>
    </tr>
    <tr>
