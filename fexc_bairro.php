...
$sql = "SELECT bairro, uf, cidade, descricao, data, hora, usuario FROM bairro WHERE bairro=$pega_bairro";
$rs = mysql_query($sql);
...
$sqlcidade = "SELECT descricao as cidade FROM cidade WHERE cidade ='$pega_cidade'";
$rscidade = mysql_query($sqlcidade);
list($cidade) = mysql_fetch_row($rscidade);
...
<hr>
<strong>Confirma Exclusão  Bairro?  | <a href="fcon_bairro.php">Retornar</a></strong>
<hr>
<form action="cexc_bairro.php?bairro=<?php print $bairro;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellpadding="1" cellspacing="1">
    <tr>
      <td width="130" align="left" valign="top"><strong>Bairro:</strong></td>
      <td width="450" align="left" valign="top"><input name="fbairro" type="text" disabled="disabled" id="fbairro" value="<?php print $bairro; ?>" size="6" maxlength="6" />
    </td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>UF:</strong></td>
      <td align="left" valign="top"><input name="fuf" type="text" disabled="disabled" id="fuf" value="<?php print $uf; ?>" size="2" maxlength="2" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Cidade:</strong></td>
      <td align="left" valign="top"><input name="fcidade" type="text" disabled="disabled" id="fcidade" value="<?php print $cidade; ?>" size="30" maxlength="30" /></td>
    </tr>
    <tr>
