...
<hr>
<strong>Confirma Exclusão Cliente?  | <a href="fcon_cliente.php">Retornar</a></strong>
<hr>
<form action="cexc_cliente.php?cliente=<?php print $cliente;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
