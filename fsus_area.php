...
<hr>
<strong>Cadastro realizado com sucesso! | <a href="fcon_area.php">Retornar</a></strong>
<hr>
<form id="form1" name="form1" method="post" action="">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td width="130" align="left" valign="top"><strong>Área:</strong></td>
      <td width="450" align="left" valign="top"><input name="farea" type="text" disabled="disabled" id="farea" value="<?php print $area; ?>" size="2" maxlength="2" readonly="readonly" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Especialidade:</strong></td>
      <td align="left" valign="top"><input name="fespecialidade" type="text" disabled="disabled" id="fespecialidade" value="<?php print $especialidade; ?>" size="2" maxlength="2" readonly="readonly" /></td>
    </tr>
    <tr>
