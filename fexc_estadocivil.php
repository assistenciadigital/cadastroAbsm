...
<hr>
<strong>Confirma Exclusão Estado Civil?  | <a href="fcon_estadocivil.php">Retornar</a></strong>
<hr>
<form action="cexc_estadocivil.php?estadocivil=<?php print $estadocivil;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Estado Civil:</strong></td>
    <td width="450" align="left" valign="top"><input name="festadocivil" type="text" disabled="disabled" id="festadocivil" value="<?php print $estadocivil; ?>" size="2" maxlength="2" />
    </td>
    </tr>
    <tr>
