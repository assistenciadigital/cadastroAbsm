...
$observacao = ("EXC: $data_atual, $hora_atual, Cliente: $cliente, Descricao: $descricao, Detalhe: $detalhe, Usuario: $idusuario_atual - $loginusuario_atual");
...
$sql = "DELETE FROM cliente WHERE cliente=$pega_cliente";
$rs = mysql_query($sql);
