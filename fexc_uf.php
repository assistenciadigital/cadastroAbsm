...
<hr>
<strong>Confirma Exclusão UF?  | <a href="fcon_uf.php">Retornar</a></strong>
<hr>
<form action="cexc_uf.php?uf=<?php print $uf;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>UF:</strong></td>
    <td width="450" align="left" valign="top"><input name="fuf" type="text" disabled="disabled" id="fuf" value="<?php print $uf; ?>" size="2" maxlength="2" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Sigla:</strong></td>
      <td align="left" valign="top"><input name="fsigla" type="text" disabled="disabled" id="fsigla" value="<?php print $sigla; ?>" size="2" maxlength="2" />
    </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="fcapital" type="text" disabled="disabled" id="fcapital" value="<?php print $capital; ?>" size="30" maxlength="30" /></td>
    </tr>
    <tr>
