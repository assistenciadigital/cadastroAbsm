...
$observacao = ("ALT: $data_atual, $hora_atual, Assistencia: $assistencia, Descricao: $descricao, Detalhe: $detalhe, Usuario: $idusuario_atual - $loginusuario_atual");
  ...
  $sql = "UPDATE assistencia SET descricao='$descricao',detalhe='$detalhe',data='$data_atual',hora='$hora_atual',usuario='$loginusuario_atual' WHERE assistencia=$pega_assistencia";
  $rs = mysql_query($sql);
