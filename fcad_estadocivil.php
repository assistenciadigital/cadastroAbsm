...
<hr>
<strong>Cadastro Estado Civil | <a href="fcon_estadocivil.php">Retornar</a></strong>
<hr>
<form action="ccad_estadocivil.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
