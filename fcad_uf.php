...
<hr>
<strong>Cadastro UF | <a href="fcon_uf.php">Retornar</a></strong>
<hr>
<form action="ccad_uf.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Sigla:</strong></td>
    <td width="450" align="left" valign="top"><input name="fsigla" type="text" id="fsigla" size="2" maxlength="2" />
    </td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Descrição:</strong></td>
      <td align="left" valign="top"><input name="fdescricao" type="text" id="fdescricao" size="30" maxlength="30" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Capital:</strong></td>
      <td align="left" valign="top"><input name="fcapital" type="text" id="fcapital" size="30" maxlength="30" /></td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Imagem:</strong></td>
      <td align="left" valign="top"><input name="fimagem" type="file" id="fimagem" size="65" maxlength="255" /></td>
    </tr>
    <tr>
