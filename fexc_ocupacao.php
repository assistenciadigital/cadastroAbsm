...
<hr>
<strong>Confirma Exclusão Ocupação?  | <a href="fcon_ocupacao.php">Retornar</a></strong>
<hr>
<form action="cexc_ocupacao.php?ocupacao=<?php print $ocupacao;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellpadding="1" cellspacing="1">
    <tr>
      <td width="130" align="left" valign="top"><strong>Ocupação:</strong></td>
      <td width="450" align="left" valign="top"><input name="focupacao" type="text" disabled="disabled" id="focupacao" value="<?php print $ocupacao; ?>" size="2" maxlength="2" />
    </td>
    </tr>
    <tr>
