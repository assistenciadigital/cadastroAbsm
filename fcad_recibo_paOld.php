...
<input name="fdatadocto" type="text" id="fdatadocto" size="10" maxlength="10" />
  ...
  <tr>
    ...
    <td align="left"><select name="femitente" id="femitente" style="width:130px">
      <?php 
		$sqlemitente = "select emitente, inscricao from recibo_emitente where emitente = '2'";
      ...
      <strong>Referência: 
        <select name="freferencia" id="freferencia" style="width:200px">
          <option value=""></option>
          <?php 
		$sqlreferencia = "select referencia, descricao from recibo_referencia where emitente = '2'";
...
$sqlrecibo = "SELECT recibo,valor,emitente,destinatario,tipo,referencia,descricao,data,hora,usuario FROM recibo where emitente = '2'";
...
<table width="640" align="left">
  <tr bgcolor="<?php if($contador % 2) { echo "#FFFF00"; }?>" valign="middle">
    ...
    <td width="23" align="left" scope="col"><a href="falt_recibo_pa.php?recibo=<?php print $recibo; ?>"><img src="imagem/ico-refresh.png" alt="" width="23" height="23"/></a><br/>
