...
<hr>
<strong>Cadastro realizado com sucesso! | <a href="fcon_insignia.php">Retornar</a></strong>
<hr>
<form id="form1" name="form1" method="post" action="">
  ...
  <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="fsigla" type="text" disabled="disabled" value="<?php print $sigla; ?>" size="20" maxlength="20" readonly="readonly" />
    </td>
    </tr>
    <tr>
      <td align="left" valign="top"><strong>Hierarquia:</strong></td>
      <td align="left" valign="top"><input name="fhierarquia" type="text" disabled="disabled" value="<?php print $hierarquia; ?>" size="2" maxlength="2" readonly="readonly" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="finstituicao" type="text" disabled="disabled" value="<?php print $instituicao; ?>" size="6" maxlength="6" readonly="readonly" /></td>
    </tr>
    <tr>
