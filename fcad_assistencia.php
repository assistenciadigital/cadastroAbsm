...
<hr>
<strong>Cadastro Assistência Médica | <a href="fcon_assistencia.php">Retornar</a></strong>
<hr>
<form action="ccad_assistencia.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
