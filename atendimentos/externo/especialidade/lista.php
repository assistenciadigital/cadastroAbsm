...
if(($_SESSION['login_usuario'])){//AND($_SESSION['nivel'])){
	...
	//$sql = mysql_query("select * from convenio_especialidade order by razao LIMIT $inicial, $numreg");
	
	// Serve para contar quantos registros você tem na seua tabela para fazer a paginação
	$sql_conta = mysql_query("SELECT * FROM convenio_especialidade");
	
	$quantreg = mysql_num_rows($sql_conta); // Quantidade de registros pra paginação
	
	$consulta = mysql_query("SELECT * FROM convenio_especialidade order by nome LIMIT $inicial, $numreg");
...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="90%" align="left" bgcolor="#4DBDCB"><h2 class="txtBranco"><strong>GERENCIAMENTO DE ESPECIALIDADES</strong></h2></td>
    </tr>
    <tr>
      <td width="10%">&nbsp;</td>
      <td width="90%">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="80%" height="25" align="left" bgcolor="<?php echo $cor?>" ><h6><?php if ($c['especialidade']=='M') echo $c['nome'].' (Especialidade: Medica)'; elseif ($c['especialidade']=='O') echo $c['nome'].' (Especialidade: Odontologica)';?></td>
      <td width="5%" align="center" bgcolor="<?php echo $cor?>"><a href="cadastro.php?id=<?php echo $c['id']?>" class="tip-tip" alt="Clique aqui para Alterar o usuário: <?php echo $c['nome'] ?>"><img name="bt_editar" src="../../../painel/imgs/i_editar.png" width="20" height="20" border="0" alt=""></a></td>
