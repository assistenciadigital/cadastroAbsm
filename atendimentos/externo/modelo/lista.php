...
if(($_SESSION['login_usuario'])){//AND($_SESSION['nivel'])){
	...
	$sql_conta = mysql_query("SELECT * FROM convenio_empresa");
	
	$quantreg = mysql_num_rows($sql_conta); // Quantidade de registros pra paginação
	
	$consulta = mysql_query("SELECT * FROM convenio_empresa order by razao, fantasia LIMIT $inicial, $numreg");
...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="90%" align="left" bgcolor="#4DBDCB"><h2 class="txtBranco"><strong>GERENCIAMENTO DE CONVENIOS</strong></h2></td>
    </tr>
    <tr>
      <td width="10%">&nbsp;</td>
      <td width="90%">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="80%" height="30" align="left" bgcolor="<?php echo $cor?>" ><h6><?php echo $c['razao'];echo '<br>';echo $c['fantasia'];?></td>
