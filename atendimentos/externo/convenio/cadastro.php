...
if(($_SESSION['login_usuario'])){//AND($_SESSION['nivel'])){
	...
	$c = @mysql_fetch_assoc(mysql_query("SELECT * FROM convenio WHERE id='".$_GET['id']."'"));
	...
	if ($_GET['id']) $titulo_pg = "ALTERANDO CONVENIOS";
	else $titulo_pg = "CADASTRANDO CONVENIOS";
?>
...
<td colspan="2" align="center" valign="top" height="400">
    ...
    <table width="765" border="0" cellspacing="0" cellpadding="1">
        ...
        <tr>
        <td width="10%" height="25" align="right"><h6>
