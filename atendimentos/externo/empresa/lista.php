...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="90%" align="left" bgcolor="#4DBDCB"><h2 class="txtBranco"><strong>GERENCIAMENTO DE EMPRESAS</strong></h2></td>
    </tr>
    <tr>
      <td width="10%">&nbsp;</td>
      <td width="90%">&nbsp;</td>
    ...
    <td width="80%" bgcolor="<?php echo $cor?>" ><h6><?php echo $c['razao'];echo '<br>';echo $c['fantasia'];?></h6></td>
