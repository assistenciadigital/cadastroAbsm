...
if(($_SESSION['login_usuario'])){//AND($_SESSION['nivel'])){
	...
	//$sql = mysql_query("select * from convenio_agenda order by razao LIMIT $inicial, $numreg");
	
	// Serve para contar quantos registros você tem na seua tabela para fazer a paginação
	$sql_conta = mysql_query("SELECT * FROM convenio_agenda");
	
	$quantreg = mysql_num_rows($sql_conta); // Quantidade de registros pra paginação
	
	$consulta = mysql_query("SELECT * FROM convenio_agenda order by razao, fantasia LIMIT $inicial, $numreg");
...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="90%" align="left" bgcolor="#4DBDCB"><h2 class="txtBranco"><strong>GERENCIAMENTO DE AGENDAMENTOS / ATENDIMENTOS</strong></h2></td>
    </tr>
    <tr>
      <td width="10%">&nbsp;</td>
      <td width="90%">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="80%" height="30" align="left" bgcolor="<?php echo $cor?>" ><h6><?php echo $c['encaminha'];echo '<br>';echo $c['fantasia'];?></td>
