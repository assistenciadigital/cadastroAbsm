...
if(($_SESSION['login_usuario'])){//AND($_SESSION['nivel'])){
	...
	$sql_conta = mysql_query("SELECT * FROM convenio_empregado");
	
	$quantreg = mysql_num_rows($sql_conta); // Quantidade de registros pra paginação
		
	$consulta = mysql_query("SELECT * FROM convenio_empregado order by nome LIMIT $inicial, $numreg");
...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="90%" align="left" bgcolor="#4DBDCB"><h2 class="txtBranco"><strong>GERENCIAMENTO DE EMPREGADOS</strong></h2></td>
    </tr>
    <tr>
      <td width="10%">&nbsp;</td>
      <td width="90%">&nbsp;</td>
    ...
    <td width="75%" bgcolor="<?php echo $cor?>" ><h6><?php echo $c['nome'];echo '<br>';echo 'Nascimento: '.date_data($c['nascimento'])?></h6></td>
    <td width="5%" align="center" valign="middle" bgcolor="<?php echo $cor?>"><a href="../dependente/lista.php?id=<?php echo $c['id']?>"class="tip-tip"><img src="../../../painel/imgs/i_dependente.png" alt="Clique aqui para Alterar o dependente: <?php echo $c['nome'] ?>" name="bt_dependente" width="30" height="30" border="0"></a></td>
    <td width="5%" align="center" valign="middle" bgcolor="<?php echo $cor?>"><a href="cadastro.php?id=<?php echo $c['id']?>" class="tip-tip" alt="Clique aqui para Alterar o usuário: <?php echo $c['nome'] ?>"><img name="bt_editar" src="../../../painel/imgs/i_editar.png" width="20" height="20" border="0" alt=""></a></td>
