...
$observacao = ("EXC: $data_atual, $hora_atual, Bairro: $bairro, Descricao: $descricao, UF: $uf, Cidade: $cidade, Usuario: $idusuario_atual - $loginusuario_atual");
...
$sql = "DELETE FROM bairro WHERE bairro=$pega_bairro";
$rs = mysql_query($sql);
