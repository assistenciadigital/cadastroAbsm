...
<hr>
<strong>Confirma Exclusão Parentesco?  | <a href="fcon_parentesco.php">Retornar</a></strong>
<hr>
<form action="cexc_parentesco.php?parentesco=<?php print $parentesco;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellpadding="1" cellspacing="1">
    <tr>
      <td width="130" align="left" valign="top"><strong>Parentesco:</strong></td>
      <td width="450" align="left" valign="top"><input name="fparentesco" type="text" disabled="disabled" id="fparentesco" value="<?php print $parentesco; ?>" size="2" maxlength="2" />
    </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top"><input name="fgrau" type="text" disabled="disabled" id="fgrau" value="<?php print $grau; ?>" size="2" maxlength="2" /></td>
    </tr>
    <tr>
