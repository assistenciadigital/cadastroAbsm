...
<hr>
<form action="cexc_formapagto.php?formapagto=<?php print $formapagto;?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="580" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td width="130" align="left" valign="top"><strong>Forma Pagto:</strong></td>
    <td width="450" align="left" valign="top"><input name="fformapagto" type="text" disabled="disabled" id="fformapagto" value="<?php print $formapagto; ?>" size="2" maxlength="2" />
    </td>
    </tr>
    <tr>
