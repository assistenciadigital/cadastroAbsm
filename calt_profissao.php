...
$observacao = ("ALT: $data_atual, $hora_atual, Profissao: $profissao, Descricao: $descricao, Usuario: $idusuario_atual - $loginusuario_atual");
  ...
  $sql = "UPDATE profissao SET descricao='$descricao',data='$data_atual',hora='$hora_atual',usuario='$loginusuario_atual' WHERE profissao=$pega_profissao";
  $rs = mysql_query($sql);
