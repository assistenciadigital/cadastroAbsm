...
<hr>
<strong>Cadastro Forma de Pagamento | <a href="fcon_formapagto.php">Retornar</a></strong>
<hr>
<form action="ccad_formapagto.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
