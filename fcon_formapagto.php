...
<hr>
<strong>Consulta Forma de Pagamento | <a href="menu.php">Retornar</a> | <a href="fcad_formapagto.php">Novo Registro +</a></strong>
<hr>
<form action="fbus_formapagto.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
...
<tr valign="middle">
    <th width="100" height="0" align="left" valign="middle" scope="col"><strong>Forma Pg</strong></th>
...
$sql = "SELECT * FROM formapagto ORDER BY descricao";
$rs = mysql_query($sql);
