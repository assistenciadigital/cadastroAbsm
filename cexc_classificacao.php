...
list($classificacao, $descricao, $detalhe, $data, $hora, $usuario) = mysql_fetch_row($rs);

$observacao = ("EXC: $data_atual, $hora_atual, classificacao: $classificacao, Descricao: $descricao, Detalhe: $detalhe, Usuario: $idusuario_atual - $loginusuario_atual");
...
$sql = "DELETE FROM classificacao WHERE classificacao=$pega_classificacao";
$rs = mysql_query($sql);
