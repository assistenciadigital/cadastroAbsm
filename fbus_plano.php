...
<hr>
<strong>Consulta Plano | <a href="fcon_plano.php">Retornar</a> | <a href="fcad_plano.php">Novo Registro +</a></strong>
<hr>
...
$sql = "SELECT plano, descricao, detalhe, data, hora, usuario FROM plano WHERE descricao LIKE '$pega_descricao%' ORDER BY descricao";
$rs = mysql_query($sql);
