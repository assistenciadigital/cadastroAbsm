...
if(($_SESSION['login']) AND($_SESSION['nivel'])){
	...
	$sql_conta = mysql_query("SELECT * FROM cadastro where classificacao = 'Socio Contribuinte'");
	
	$quantreg = mysql_num_rows($sql_conta); // Quantidade de registros pra paginação
		
	$consulta = mysql_query("SELECT * FROM cadastro where classificacao = 'Socio Contribuinte' order by nome LIMIT $inicial, $numreg");
...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="90%" align="left" bgcolor="#4DBDCB"><h2 class="txtBranco"><strong>GERENCIAMENTO DE SÓCIOS CONTRIBUINTE</strong></h2></td>
    </tr>
    <tr>
      <td width="10%">&nbsp;</td>
      <td width="90%">&nbsp;</td>
  ...
  <table width="800" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="65%" align="left" scope="col"><h6><strong>Nome</strong></h6></td>
      ...
      <td width="5%" align="center" scope="col"><h6><strong>Excluí</strong></h6></td>
    </tr>
  </table>
<?php
    if (@mysql_num_rows($consulta)){
		...
		switch($c['status']){
			...
			case "Bloqueado":   $status = $c['status']."/Procure Financeiro"; $cor = '#FF00FF"';break;
			case "Excluido":    $status = $c['status'];                          $cor = '#FF0000'; break;
			case "Inativo":     $status = $c['status'];                          $cor = '#FF0000'; break;
			case "Recadastrar": $status = $c['status']."/Procure Cadastro";   $cor = '#FF0000'; break;						
			}
    ?>   
    <table width="800" border="0" cellpadding="1" cellspacing="1" bgcolor="#E0E0E0">
    <tr>
    ...
    <td width="65%" onMouseOut="this.style.backgroundColor='<?php echo $cor?>'" onMouseOver="this.style.backgroundColor='#E0E0E0'" style="cursor:hand" bgcolor="<?php echo $cor?>" ><h6><strong><?php echo $c['nome'];echo '<br>';echo 'Nascimento: '.date_data($c['nascimento']).' | CPF: '.$c['cpf'].' | Status: '.$status?></strong></h6></td>
    ...
    <td width="5%" align="center" valign="middle" onMouseOut="this.style.backgroundColor='<?php echo $cor?>'" onMouseOver="this.style.backgroundColor='#E0E0E0'" style="cursor:hand" bgcolor="<?php echo $cor?>"><a href="../../relatorio/crel_ficha_atendimento.php?id=<?php echo $c['id']?>" target="_blank" class="tip-tip" alt="Clique aqui para Alterar o usuário: <?php echo $c['nome'] ?>"><img name="bt_editar" src="../../painel/imgs/i_ficha.png" width="30" height="29" border="0" alt=""></a></td>
    <td width="5%" align="center" valign="middle" onMouseOut="this.style.backgroundColor='<?php echo $cor?>'" onMouseOver="this.style.backgroundColor='#E0E0E0'" style="cursor:hand" bgcolor="<?php echo $cor?>"><strong><a href="../dependente/lista.php?id=<?php echo $c['id']?>"class="tip-tip"><img src="../../painel/imgs/ico-carteira.png" alt="Clique aqui para Alterar o dependente: <?php echo $c['nome'] ?>" name="bt_dependente" width="29" height="29" border="0"></a></strong></td>
    ...
    <td width="5%" align="center" valign="middle" onMouseOut="this.style.backgroundColor='<?php echo $cor?>'" onMouseOver="this.style.backgroundColor='#E0E0E0'" style="cursor:hand" bgcolor="<?php echo $cor?>"><strong><a href="javascript: excluir (<?php echo $c['id'] ?>)" class="tip-tip" alt="Clique aqui para excluir o usuário: <?php echo $c['id']?>"><img src="../../painel/imgs/i_excluir.png" border="0" style="cursor:hand"></a></strong></td>
    </tr>
</table>    
