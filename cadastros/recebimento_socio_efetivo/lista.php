...
if(($_SESSION['login']) AND($_SESSION['nivel'])){
	...
	$sql_conta = mysql_query("SELECT * FROM financeiro_recebimento WHERE titular='".$_GET['id']."'");
	
	$quantreg = mysql_num_rows($sql_conta); // Quantidade de registros pra paginação

	$titular  = @mysql_fetch_assoc(mysql_query("SELECT id, nome FROM cadastro WHERE id='".$_GET['id']."'"));	

	$consulta = mysql_query("SELECT financeiro_recebimento.id, financeiro_recebimento.titular as titular, financeiro_recebimento.titular, financeiro_recebimento.descricao, auxiliar.nome AS formapagto, financeiro_recebimento.competencia, financeiro_recebimento.recebimento, financeiro_recebimento.valor FROM financeiro_recebimento INNER JOIN auxiliar ON financeiro_recebimento.formapagto = auxiliar.id WHERE financeiro_recebimento.titular='".$_GET['id']."' ORDER BY financeiro_recebimento.competencia LIMIT $inicial, $numreg");
...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="90%" align="left" bgcolor="#4DBDCB"><h2 class="txtBranco"><strong>GERENCIAMENTO DE RECEBIMENTO - SOCIO EFETIVO</strong></h2></td>
    </tr>
    <tr>
      <td width="10%">&nbsp;</td>
      <td width="90%">&nbsp;</td>
  ...
  <div style="color:#009; width:820px; height: 286px; overflow: auto; vertical-align: left;"> 
    ...
    if (@mysql_num_rows($consulta)){
		...
		$especialidade  = @mysql_fetch_assoc(mysql_query("SELECT id, nome FROM especialidade WHERE id='".$c['especialidade']."'"));	
	        $i++;
    	    if ($i%2) $cor = '#F0F0F0';
			else $cor = '#FFFFFF';
    ?>   
    ...
    <td width="50%" bgcolor="<?php echo $cor?>" ><h6><?php echo $c['descricao'].'<br/>'.$c['formapagto']?></h6></td>
    <td width="10%" align="center" bgcolor="<?php echo $cor?>" ><h6><?php echo date_data($c['competencia'])?></h6></td>
    <td width="10%" align="center" bgcolor="<?php echo $cor?>" ><h6><?php echo date_data($c['recebimento'])?></h6></td>
    <td width="10%" align="right" bgcolor="<?php echo $cor?>" ><h6><?php echo number_format($c['valor'],2,',','.')?></h6></td>
    <td width="5%" align="center" valign="middle" bgcolor="<?php echo $cor?>"><a href="cadastro.php?id=<?php echo $c['id']?>&titular=<?php echo $c['titular']?>" class="tip-tip"><img name="bt_editar" src="../../painel/imgs/i_editar.png" width="20" height="20" border="0" alt=""></a></td>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="100%" align="right" class="voltar"><img src="../../painel/imgs/space.png" width="10" height="25"><a href="../socio_efetivo/lista.php"><img src="../../painel/imgs/bt_voltar.png" border="0"></a><img src="../../painel/imgs/space.png" width="10" height="25"><img src="../../painel/imgs/spaceT.png" width="20" height="25"></td>
        </tr>
</table>
