...
if(($_SESSION['login']) AND($_SESSION['nivel'])){
	...
	$c  = @mysql_fetch_assoc(mysql_query("SELECT * FROM particular WHERE id='".$_GET['id']."'"));
							 		
	if ($_GET['id']) $titulo_pg = "ALTERANDO PARTICULAR | CONVENIO SUS";
	else $titulo_pg = "CADASTRANDO PARTICULAR | CONVENIO SUS";
?>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="25" align="right"><h6>Classificação:</h6></td>
    <td align="left"><h6><input name="classificacao" type="radio" class="form_obrig" id="classificacao" value="Particular" <?php if($c['classificacao'] == "Particular") echo "checked" ?>>&nbsp;Particular&nbsp;<input name="classificacao" type="radio" class="form_obrig" id="origem" value="Convenio SUS" <?php if($c['classificacao'] == "Convenio SUS") echo "checked" ?>/>&nbsp;Convênio SUS&nbsp;|&nbsp;Cor:&nbsp;<select name="cor" class="form_obrig" id="cor" style="width:130px; height: 20px;">
