...
<hr>
<strong>Confirma Exclusão Plano?  | <a href="fcon_plano.php">Retornar</a></strong>
    <hr>
      <form action="cexc_plano.php?plano=<?php print $pega_plano;?>" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onsubmit="return validacampos(); return false;">
        <fieldset>
